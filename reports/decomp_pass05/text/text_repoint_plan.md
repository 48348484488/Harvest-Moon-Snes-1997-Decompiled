...
- Edited entries: **0**
- In-place safe edits: **0**
- Repoint-needed edits: **0**
- Encoding errors: **0**
- Unchanged/blank entries: **1177**

## Outputs

- Plan CSV: `reports/decomp_pass05/text/text_repoint_plan.csv`
- New text block preview ASM: `patches/pass05_repoint_text_blocks_preview.asm`
- Pointer-table replacement preview: `patches/pass05_pointer_table_replacements_preview.asm`
