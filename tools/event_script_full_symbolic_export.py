#!/usr/bin/env python3
"""
Pass 58 helper: full symbolic EventScript export for B3-B5.
...
def main() -> int:
    ...
    group_dir = args.out_dir / "event_script_groups_pass58"
    ...
    profile_csv = args.out_dir / "event_script_group_semantic_map_pass58.csv"
    ...
    entries_csv = args.out_dir / "event_script_full_symbolic_entries_pass58.csv"
    ...
    md_path = args.out_dir / "event_script_full_symbolic_export_pass58.md"
    ...
    with md_path.open("w", encoding="utf-8") as fp:
        fp.write("# Pass 58 - Full EventScript symbolic export B3-B5\n\n")
        ...
        fp.write(f"- Per-group files: `reports/event_script_groups_pass58/EventScriptGroup_XX.md`\n\n")
        ...
        fp.write("|---:|---:|---:|---:|---:|---:|---|---|---|\n")
        for p in profiles:
            file_name = f"event_script_groups_pass58/EventScriptGroup_{p.gid:02X}.md"
    ...
    hints_path = args.out_dir / "event_script_memory_role_hints_pass58.md"
    ...
    with hints_path.open("w", encoding="utf-8") as fp:
        fp.write("# Pass 58 - EventScript RAM role hints\n\n")
