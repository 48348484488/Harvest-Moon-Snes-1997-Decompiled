...
ToolAnimationWateringCan: ;8291A9
        ...
        %Set8bit(!M)
        CMP.B #$02
        BEQ .ToolAnimation_Branch_8291D5
        LDA.W !watering_can_water
        BEQ .ToolAnimation_Branch_8291C8
        %Set16bit(!MX)
        LDA.W #$0068
        CLC
        ADC.B !player_direction
        STA.W $0901
        BRA .ToolAnimation_Branch_8291E7

    .ToolAnimation_Branch_8291C8:
        %Set16bit(!MX)
        LDA.W #$006C
        CLC
        ADC.B !player_direction
    ...
    .ToolAnimation_Branch_8291E7: RTS
