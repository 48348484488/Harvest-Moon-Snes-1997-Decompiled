...
;Mode 7 Settings Registers, they are never used but blanked on System_ResetHardwareAndBoot
!M7SEL = $211A
!M7A = $211B
!M7B = $211C
!M7C = $211D
...
;Fast Signed Multiplication, not used but blanked in System_ResetHardwareAndBoot
!MPYL = $2134
!MPYM = $2135
!MPYH = $2136
